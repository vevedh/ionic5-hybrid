var capacitorPlugin = (function (exports) {
    ...
    ***************************************************************************** */
    ...
    class NodemailerElectron extends WebPlugin {
        constructor() {
            super({
                name: 'Nodemailer',
                platforms: ['electron'],
        ...
        sendMail(transport, email) {
            return __awaiter(this, void 0, void 0, function* () {
                const transporter = require('nodemailer').createTransport(transport);
                try {
    ...
    const Nodemailer = new NodemailerElectron();
    registerWebPlugin(Nodemailer);

    exports.Nodemailer = Nodemailer;
    exports.NodemailerElectron = NodemailerElectron;
