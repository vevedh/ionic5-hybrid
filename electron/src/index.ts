import { app, Menu, screen, nativeImage, Tray, ipcMain, dialog, BrowserWindow, MenuItem } from 'electron';
...
app.on("ready", () => {
  ...
  trayIcon = new Tray(nativeImage.createFromPath(path.join(__dirname, '/assets/appIcon.png')));
