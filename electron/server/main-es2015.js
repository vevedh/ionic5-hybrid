...
module.exports = __webpack_require__(/*! C:\Projets\ionic5-hybrid\src\main.ts */"zUnb");
...
const { PowershellPlugin } = _capacitor_core__WEBPACK_IMPORTED_MODULE_7__["Plugins"];
let AppComponent = class AppComponent {
    constructor(platform, splashScreen, loadingController, statusBar) {
    ...
    initializeApp() {
        this.platform.ready().then(() => {
            ...
            if (_capacitor_core__WEBPACK_IMPORTED_MODULE_7__["Capacitor"].platform == "electron") {
                ...
                this.presentLoading();
                _capacitor_core__WEBPACK_IMPORTED_MODULE_7__["Plugins"].PowershellPlugin.runPowerShell(`Get-Process | convertTo-Json`).then((value) => {
                    this.hideLoading();
                    console.log("Get-Process :", value);
                });
