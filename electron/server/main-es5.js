(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
    ...
    function _(module, exports, __webpack_require__) {
      ...
      /*! C:\Projets\ionic5-hybrid\src\main.ts */
      "zUnb");
      /***/
    },
    ...
    function Sy1n(module, __webpack_exports__, __webpack_require__) {
      ...
      /*! @capacitor/core */
      "gcOT"); //import { PowershellPlugin} from 'cap-powershell';


      var PowershellPlugin = _capacitor_core__WEBPACK_IMPORTED_MODULE_7__["Plugins"].PowershellPlugin;

      var AppComponent = /*#__PURE__*/function () {
        function AppComponent(platform, splashScreen, loadingController, statusBar) {
          ...
          value: function initializeApp() {
            ...
            this.platform.ready().then(function () {
              ...
              if (_capacitor_core__WEBPACK_IMPORTED_MODULE_7__["Capacitor"].platform == "electron") {
                ...
                _capacitor_core__WEBPACK_IMPORTED_MODULE_7__["Plugins"].PowershellPlugin.runPowerShell("Get-Process | convertTo-Json").then(function (value) {
                  _this.hideLoading();

                  console.log("Get-Process :", value);
                });

                PowershellPlugin.echo('test de veve').then(function (val) {
